...
function runRace(raceID) {
	return new Promise(resolve => {
		...
		const raceInterval = setInterval(runRaceCallBack, 500);
		async function runRaceCallBack() {
...
function getTracks() {
	...
	.then(res => res.json())
	.catch(err => console.log(`GET request from ${SERVER}/api/tracks failed. Error with the getTracks function: ${err}`));
}
...
function getRacers() {
	...
	.then(res => res.json())
	.catch(err => console.log(`GET request from ${SERVER}/api/cars failed. Error with the getRacers function: ${err}.`));
}
...
function getRace(id) {
	...
	.then(res => res.json())
	.catch(err => console.log(`GET request from ${SERVER}/api/cars/${id} failed. Error with the getRace function: ${err}.`));
}
